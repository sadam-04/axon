...
if "%1"=="debug" (
    ...
    mkdir "out/debug/"
    cl src/main.cpp src/nayuki-qr/qrcodegen.cpp src/webserver.cpp src/dataloader.cpp src/qr_to_bmp.cpp src/window.cpp src/gethost.cpp /Fe:out/debug/Axon.exe /Fo:out/debug/ /I src/SFML-2.6.2/include /link /LIBPATH:"src\SFML-2.6.2\lib" sfml-graphics.lib sfml-window.lib sfml-system.lib
) else (
